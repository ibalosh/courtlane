...
export function AccountLayout() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(242,201,76,0.45),transparent_32%),linear-gradient(180deg,#f6f1e9_0%,#ece5d9_100%)] p-8 text-slate-900 [scrollbar-gutter:stable]">
